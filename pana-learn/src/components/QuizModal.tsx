...
export const QuizModal: React.FC<QuizModalProps> = ({
    ...
    useEffect(() => {
        if (isOpen && quizConfig) {
            console.log("Quiz modal aberto com config:", quizConfig)
            ...
            <Dialog open={isOpen} onOpenChange={onClose}>
                <DialogContent className="max-w-2xl">
                    ...
                    <div className="text-center py-8">
                        ...
                        <p className="text-lg font-medium text-gray-700">Preparando suas perguntas...</p>
                    </div>
                </DialogContent>
            </Dialog>
        )
                    ...
                    <div className="text-center space-y-6">
                        {nota >= quizConfig.nota_minima ? (
                            <div className="space-y-4">
                                ...
                                <h3 className="text-2xl font-bold text-green-600">Parabéns! Você foi aprovado! 🎉</h3>
                                <div className="text-4xl font-bold text-green-600">{nota}%</div>
                                <p className="text-gray-600">{quizConfig.mensagem_sucesso}</p>
                            </div>
                        ) : (
                            <div className="space-y-4">
                                <XCircle className="w-20 h-20 text-red-500 mx-auto" />
                                <h3 className="text-2xl font-bold text-red-600">Não foi dessa vez 😔</h3>
                                <div className="text-4xl font-bold text-red-600">{nota}%</div>
                                <p className="text-gray-600">{quizConfig.mensagem_reprova}</p>
                                <p className="text-sm text-gray-500">Nota mínima necessária: {quizConfig.nota_minima}%</p>
                            </div>
                        )}
