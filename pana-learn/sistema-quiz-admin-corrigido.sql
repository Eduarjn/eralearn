...
-- 2. Verificar e corrigir mapeamento de cursos para quizzes
...
-- 3. Inserir/atualizar mapeamentos específicos
...
-- 4. Garantir que os quizzes específicos existem e estão ativos
...
-- 5. Criar/atualizar função para buscar quiz por curso
...
-- 6. Verificar permissões RLS para administradores
