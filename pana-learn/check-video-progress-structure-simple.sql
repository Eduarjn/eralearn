-- Script simplificado para verificar e corrigir estrutura da tabela video_progress
...
-- 6. Testar inserção com dados corretos (usando user_id válido)
...
SELECT 
    ...
    concluido
FROM video_progress 
WHERE video_id = '00000000-0000-0000-0000-000000000000';

-- 8. Limpar dados de teste (usando user_id válido)
DO $$
DECLARE
    valid_user_id uuid;
BEGIN
